...
// ========================
// FUNÇÃO UNIVERSAL (IGUAL SERVIÇOS)
// ========================
...
async function carregarProfissionais() {
  ...
  console.log("ID BARBEARIA:", idBarbearia);
  ...
  const res = await fetch(`../Barbearia/profissionais.php?action=listar&id=${idBarbearia}`);
...
async function abrirModalEditar(id) {
  const res = await fetch(`../Barbearia/profissionais.php?action=buscar&id=${id}`);
...
async function salvarProfissional(e) {
  ...
  const res = await fetch(`../Barbearia/profissionais.php?action=${action}`, {
    method: "POST",
    body: formData
  });
...
async function excluirProfissional(id) {
  ...
  const res = await fetch(`../Barbearia/profissionais.php?action=excluir&id=${id}`);
  const msg = await res.text();
